...
def test_valid_registration():
    ...
    try:
        ...
        driver.get_screenshot_as_file("./Home page is visible successfully.png")
    except AssertionError:
        print("home page is not visible successfully")
        driver.get_screenshot_as_file("./Home page is not visible successfully.png")
    ...
    try:
        ...
        print("'5. New User Signup!' is visible")
